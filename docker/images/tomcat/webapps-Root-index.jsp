...
request.setAttribute("magicUrl", "http://www.metamagicglobal.com/");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        <div id="wrapper">
            <div id="navigation" class="curved container">
                <span id="nav-magic"><a href="${magicUrl}">MetaMagic</a></span>
            ...
            <div id="asf-box">
                <h1>${pageContext.servletContext.serverInfo} MetaMagic Docker Container</h1>
            </div>
            <div id="upper" class="curved container">
                <div id="congrats" class="curved container">
                    <h2>If you're seeing this, you've successfully installed Containerized Tomcat. Congratulations!</h2>
                </div>
                <div id="notice">
